...
├── slide1-5/  - สไลด์ประกอบการสอน บทที่ 1-5
...
### สไลด์ประกอบการสอน (`slide1-5/`)
- `1-คอมพิวเตอร์และองค์ประกอบพื้นฐาน.pptx` — บทที่ 1: ระบบคอมพิวเตอร์และองค์ประกอบพื้นฐาน
- `2-แนวคิดเชิงคำนวณและการออกแบบอัลกอริธึม.pptx` — บทที่ 2: แนวคิดเชิงคำนวณและการออกแบบขั้นตอนวิธี
- `3-พื้นฐานภาษาคอมพิวเตอร์.pptx` — บทที่ 3: ภาษาคอมพิวเตอร์
- `4-Java 101 ปฐมบทสู่โค้ดมหัศจรรย์.pptx` — บทที่ 4: แนะนำภาษา Java และสภาพแวดล้อมการพัฒนา
- `5-Java 101_ โครงสร้างสู่โค้ดมืออาชีพ.pptx` — บทที่ 5: ส่วนประกอบของโปรแกรม Java และชนิดข้อมูล
